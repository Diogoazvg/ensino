...
RSpec.describe ProfessoresController, :type => :controller do
  ...
  # ProfessoresController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all professores as @professores" do
      professor = Professor.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:professores)).to eq([professor])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved professor as @professor" do
        post :create, {:professor => invalid_attributes}, valid_session
        expect(assigns(:professor)).to be_a_new(Professor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested professor" do
        professor = Professor.create! valid_attributes
        put :update, {:id => professor.to_param, :professor => new_attributes}, valid_session
        professor.reload
    ...
    describe "with invalid params" do
      it "assigns the professor as @professor" do
        professor = Professor.create! valid_attributes
        put :update, {:id => professor.to_param, :professor => invalid_attributes}, valid_session
        expect(assigns(:professor)).to eq(professor)
      end
